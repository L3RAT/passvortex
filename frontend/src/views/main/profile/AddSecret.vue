        ...
        <template>
          <v-form v-model="valid" ref="form" lazy-validation>
            ...
            <v-layout align-center>
              <v-flex>
                <v-text-field type="Type password" ref="password" label="Set Password" data-vv-name="password" data-vv-delay="100" v-validate="{required: true, min:8 , verify_password}" v-model="password" :error-messages="errors.first('password')">
                </v-text-field>
              </v-flex>
            </v-layout>
          </v-form>
